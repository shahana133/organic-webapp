...
class Product(models.Model):
    ...
    unit = models.CharField(max_length=10, choices=UNIT_CHOICES, default='kg')  # ✅ Add this line
...
class UserProfile(models.Model):
    ...
    phone = models.CharField(max_length=15, blank=True, null=True)  # No unique=True
    image = models.ImageField(upload_to='profiles/', blank=True, null=True)  # ✅ Added image field
